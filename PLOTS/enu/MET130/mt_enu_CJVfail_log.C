...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-85.06329,-2.901614,446.5823,7.014237);
   ...
   mt_enu_stack_10->SetMinimum(0.001980171);
   mt_enu_stack_10->SetMaximum(3299475);

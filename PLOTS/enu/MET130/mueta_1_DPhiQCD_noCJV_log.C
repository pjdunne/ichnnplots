...
// ------------>Primitives in pad: upper
   ...
   mueta_1_stack_9->SetBinContent(0,0.1129965);
   mueta_1_stack_9->SetBinError(0,0.08247561);
   mueta_1_stack_9->SetMinimum(-0);
   mueta_1_stack_9->SetMaximum(nan);
   mueta_1_stack_9->SetEntries(2);

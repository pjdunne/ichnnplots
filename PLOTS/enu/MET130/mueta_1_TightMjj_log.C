...
// ------------>Primitives in pad: upper
   ...
   mueta_1_stack_7->SetBinContent(0,19.8864);
   mueta_1_stack_7->SetBinError(0,5.965893);
   mueta_1_stack_7->SetMinimum(-0);
   mueta_1_stack_7->SetMaximum(nan);
   mueta_1_stack_7->SetEntries(43);

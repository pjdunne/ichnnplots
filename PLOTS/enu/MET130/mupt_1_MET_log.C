...
// ------------>Primitives in pad: upper
   ...
   mupt_1_stack_6->SetBinContent(0,36.1143);
   mupt_1_stack_6->SetBinError(0,7.641416);
   mupt_1_stack_6->SetMinimum(-0);
   mupt_1_stack_6->SetMaximum(nan);
   mupt_1_stack_6->SetEntries(113);
   ...
   mupt_1->SetBinContent(0,36.1143);
   mupt_1->SetBinError(0,7.641416);
   mupt_1->SetMinimum(0.01);
   mupt_1->SetMaximum(0);
   mupt_1->SetEntries(113);
   mupt_1->SetStats(0);
   ...
   TH1F *mupt_1 = new TH1F("mupt_1","mupt_1",25,0,1000);
   mupt_1->SetBinContent(0,148.9455);
   mupt_1->SetBinError(0,9.744753);
   mupt_1->SetEntries(316);
   mupt_1->SetStats(0);
   ...
   TH1F *mupt_1 = new TH1F("mupt_1","mupt_1",25,0,1000);
   mupt_1->SetBinContent(0,607.2792);
   mupt_1->SetBinError(0,20.12866);
   mupt_1->SetEntries(1364);
   mupt_1->SetStats(0);
   ...
   TH1F *mupt_1 = new TH1F("mupt_1","mupt_1",25,0,1000);
   mupt_1->SetBinContent(0,184.2866);
   mupt_1->SetBinError(0,1.89376);
   mupt_1->SetEntries(11206);
   mupt_1->SetStats(0);
   ...
   TH1F *mupt_1 = new TH1F("mupt_1","mupt_1",25,0,1000);
   mupt_1->SetBinContent(0,0.1562384);
   mupt_1->SetBinError(0,0.1562384);
   mupt_1->SetEntries(1);
   mupt_1->SetStats(0);
   ...
   TH1F *mupt_1 = new TH1F("mupt_1","mupt_1",25,0,1000);
   mupt_1->SetBinContent(0,8.675158);
   mupt_1->SetBinError(0,0.9686398);
   mupt_1->SetEntries(113);
   mupt_1->SetStats(0);
   mupt_1->SetFillColor(3);
   mupt_1->SetLineColor(3);
   ...
   TH1F *mupt_1 = new TH1F("mupt_1","mupt_1",25,0,1000);
   mupt_1->SetBinContent(0,2.130371);
   mupt_1->SetBinError(0,0.1158411);
   mupt_1->SetEntries(398);
   mupt_1->SetStats(0);
   mupt_1->SetFillColor(3);
   mupt_1->SetLineColor(3);
   mupt_1->SetLineWidth(2);
   ...
   TH1F *mupt_1 = new TH1F("mupt_1","mupt_1",25,0,1000);
   mupt_1->SetBinContent(0,719);
   mupt_1->SetBinError(0,26.81418);
   mupt_1->SetEntries(719);
   mupt_1->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *mupt_1 = new TH1F("mupt_1","mupt_1",25,0,1000);
   mupt_1->SetBinContent(0,0.7556704);
   mupt_1->SetBinError(0,0.03335494);
   mupt_1->SetMinimum(0);
   mupt_1->SetMaximum(2);
   mupt_1->SetStats(0);
   mupt_1->SetFillStyle(0);

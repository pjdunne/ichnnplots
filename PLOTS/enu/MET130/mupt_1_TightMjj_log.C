...
// ------------>Primitives in pad: upper
   ...
   mupt_1_stack_7->SetBinContent(0,19.8864);
   mupt_1_stack_7->SetBinError(0,5.965893);
   mupt_1_stack_7->SetMinimum(-0);
   mupt_1_stack_7->SetMaximum(nan);
   mupt_1_stack_7->SetEntries(43);

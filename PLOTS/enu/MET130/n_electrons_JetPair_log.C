...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-3.010581,6.379747,8.906173);
   ...
   stack->SetMaximum(6.88545e+07);
   
   TH1F *n_electrons_stack_3 = new TH1F("n_electrons_stack_3","stack",10,0,10);
   n_electrons_stack_3->SetBinContent(2,120.5777);
   n_electrons_stack_3->SetBinContent(3,29.62337);
   n_electrons_stack_3->SetBinContent(4,2.509556);
   n_electrons_stack_3->SetBinContent(5,0.05609143);
   n_electrons_stack_3->SetBinError(2,11.43351);
   n_electrons_stack_3->SetBinError(3,5.160497);
   n_electrons_stack_3->SetBinError(4,1.233361);
   n_electrons_stack_3->SetBinError(5,0.03462637);
   n_electrons_stack_3->SetMinimum(0.001689484);
   n_electrons_stack_3->SetMaximum(2.043317e+08);
   n_electrons_stack_3->SetEntries(1236);
   ...
   n_electrons->SetBinContent(2,120.5777);
   n_electrons->SetBinContent(3,29.62337);
   n_electrons->SetBinContent(4,2.509556);
   n_electrons->SetBinContent(5,0.05609143);
   n_electrons->SetBinError(2,11.43351);
   n_electrons->SetBinError(3,5.160497);
   n_electrons->SetBinError(4,1.233361);
   n_electrons->SetBinError(5,0.03462637);
   n_electrons->SetMinimum(0.01);
   n_electrons->SetMaximum(6.159e+07);
   n_electrons->SetEntries(1236);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(2,797.4585);
   n_electrons->SetBinContent(3,428.6487);
   n_electrons->SetBinContent(4,100.156);
   n_electrons->SetBinContent(5,20.32446);
   n_electrons->SetBinContent(6,3.254418);
   n_electrons->SetBinError(2,17.93947);
   n_electrons->SetBinError(3,13.07858);
   n_electrons->SetBinError(4,6.390565);
   n_electrons->SetBinError(5,3.081851);
   n_electrons->SetBinError(6,1.442768);
   n_electrons->SetEntries(6228);
   n_electrons->SetStats(0);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(2,3021.474);
   n_electrons->SetBinContent(3,619.2178);
   n_electrons->SetBinContent(4,59.70457);
   n_electrons->SetBinContent(5,5.489461);
   n_electrons->SetBinContent(6,0.5677289);
   n_electrons->SetBinContent(7,0.1477797);
   n_electrons->SetBinError(2,37.21038);
   n_electrons->SetBinError(3,15.38756);
   n_electrons->SetBinError(4,4.350568);
   n_electrons->SetBinError(5,1.154316);
   n_electrons->SetBinError(6,0.4351492);
   n_electrons->SetBinError(7,0.1477797);
   n_electrons->SetEntries(17394);
   n_electrons->SetStats(0);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(2,594.8986);
   n_electrons->SetBinContent(3,78.04377);
   n_electrons->SetBinContent(4,5.249675);
   n_electrons->SetBinContent(5,0.2415775);
   n_electrons->SetBinError(2,3.037969);
   n_electrons->SetBinError(3,1.08095);
   n_electrons->SetBinError(4,0.2819003);
   n_electrons->SetBinError(5,0.05711162);
   n_electrons->SetEntries(61469);
   n_electrons->SetStats(0);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(2,0.4852259);
   n_electrons->SetBinContent(3,0.1769089);
   n_electrons->SetBinContent(4,0.05528804);
   n_electrons->SetBinError(2,0.2313602);
   n_electrons->SetBinError(3,0.1237554);
   n_electrons->SetBinError(4,0.05528804);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(2,49.10141);
   n_electrons->SetBinContent(3,24.90326);
   n_electrons->SetBinContent(4,4.890807);
   n_electrons->SetBinContent(5,0.4973149);
   n_electrons->SetBinContent(6,0.06924541);
   n_electrons->SetBinError(2,1.880485);
   n_electrons->SetBinError(3,1.203464);
   n_electrons->SetBinError(4,0.5578852);
   n_electrons->SetBinError(5,0.1441302);
   n_electrons->SetBinError(6,0.05791325);
   n_electrons->SetEntries(2244);
   n_electrons->SetStats(0);
   n_electrons->SetFillColor(3);
   n_electrons->SetLineColor(3);
   n_electrons->SetLineWidth(2);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(2,6.303905);
   n_electrons->SetBinContent(3,2.419471);
   n_electrons->SetBinContent(4,0.3017607);
   n_electrons->SetBinContent(5,0.02634648);
   n_electrons->SetBinContent(6,0.00673951);
   n_electrons->SetBinError(2,0.1771625);
   n_electrons->SetBinError(3,0.1066132);
   n_electrons->SetBinError(4,0.03654603);
   n_electrons->SetBinError(5,0.009853854);
   n_electrons->SetBinError(6,0.00673951);
   n_electrons->SetEntries(2681);
   n_electrons->SetStats(0);
   n_electrons->SetFillColor(3);
   n_electrons->SetLineColor(3);
   n_electrons->SetLineWidth(2);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(2,4106);
   n_electrons->SetBinContent(3,1215);
   n_electrons->SetBinContent(4,197);
   n_electrons->SetBinContent(5,31);
   n_electrons->SetBinContent(6,2);
   n_electrons->SetBinError(2,64.07808);
   n_electrons->SetBinError(3,34.85685);
   n_electrons->SetBinError(4,14.03567);
   n_electrons->SetBinError(5,5.567764);
   n_electrons->SetBinError(6,1.414214);
   n_electrons->SetEntries(5551);
   n_electrons->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(2,0.9186254);
   n_electrons->SetBinContent(3,1.053398);
   n_electrons->SetBinContent(4,1.156387);
   n_electrons->SetBinContent(5,1.166327);
   n_electrons->SetBinContent(6,0.5130662);
   n_electrons->SetBinError(2,0.01667762);
   n_electrons->SetBinError(3,0.03543533);
   n_electrons->SetBinError(4,0.09777544);
   n_electrons->SetBinError(5,0.2545233);
   n_electrons->SetBinError(6,0.4135429);
   n_electrons->SetMinimum(0);
   n_electrons->SetMaximum(2);
   n_electrons->SetEntries(93.62323);
   n_electrons->SetStats(0);
   n_electrons->SetFillStyle(0);
   n_electrons->SetMarkerStyle(20);
   n_electrons->SetMarkerSize(0.8);

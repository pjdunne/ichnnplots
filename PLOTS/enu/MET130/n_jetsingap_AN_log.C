...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-4.253164,-2.96447,22.32911,8.082511);
   ...
   stack->SetMaximum(1.203688e+07);
   
   TH1F *n_jetsingap_stack_4 = new TH1F("n_jetsingap_stack_4","stack",50,0,50);
   n_jetsingap_stack_4->SetBinContent(1,28.77404);
   n_jetsingap_stack_4->SetBinContent(2,15.33748);
   n_jetsingap_stack_4->SetBinContent(3,2.684356);
   n_jetsingap_stack_4->SetBinContent(4,0.3075812);
   n_jetsingap_stack_4->SetBinContent(6,0.05750282);
   n_jetsingap_stack_4->SetBinError(1,6.770766);
   n_jetsingap_stack_4->SetBinError(2,5.000804);
   n_jetsingap_stack_4->SetBinError(3,2.149346);
   n_jetsingap_stack_4->SetBinError(4,0.1751826);
   n_jetsingap_stack_4->SetBinError(6,0.05750282);
   n_jetsingap_stack_4->SetMinimum(0.00180497);
   n_jetsingap_stack_4->SetMaximum(3.389708e+07);
   n_jetsingap_stack_4->SetEntries(136);
   ...
   n_jetsingap->SetBinContent(1,28.77404);
   n_jetsingap->SetBinContent(2,15.33748);
   n_jetsingap->SetBinContent(3,2.684356);
   n_jetsingap->SetBinContent(4,0.3075812);
   n_jetsingap->SetBinContent(6,0.05750282);
   n_jetsingap->SetBinError(1,6.770766);
   n_jetsingap->SetBinError(2,5.000804);
   n_jetsingap->SetBinError(3,2.149346);
   n_jetsingap->SetBinError(4,0.1751826);
   n_jetsingap->SetBinError(6,0.05750282);
   n_jetsingap->SetMinimum(0.01);
   n_jetsingap->SetMaximum(7995000);
   n_jetsingap->SetEntries(136);
   ...
   TH1F *n_jetsingap = new TH1F("n_jetsingap","n_jetsingap",50,0,50);
   n_jetsingap->SetBinContent(1,36.14295);
   n_jetsingap->SetBinContent(2,73.42588);
   n_jetsingap->SetBinContent(3,88.70047);
   n_jetsingap->SetBinContent(4,53.00069);
   n_jetsingap->SetBinContent(5,23.72101);
   n_jetsingap->SetBinContent(6,9.20647);
   n_jetsingap->SetBinContent(7,1.790311);
   n_jetsingap->SetBinContent(8,0.7935151);
   n_jetsingap->SetBinError(1,4.755249);
   n_jetsingap->SetBinError(2,7.115571);
   n_jetsingap->SetBinError(3,7.85432);
   n_jetsingap->SetBinError(4,6.209833);
   n_jetsingap->SetBinError(5,4.102131);
   n_jetsingap->SetBinError(6,2.718367);
   n_jetsingap->SetBinError(7,1.276624);
   n_jetsingap->SetBinError(8,0.7935151);
   n_jetsingap->SetEntries(519);
   n_jetsingap->SetStats(0);
   ...
   TH1F *n_jetsingap = new TH1F("n_jetsingap","n_jetsingap",50,0,50);
   n_jetsingap->SetBinContent(1,496.3518);
   n_jetsingap->SetBinContent(2,305.6755);
   n_jetsingap->SetBinContent(3,110.0209);
   n_jetsingap->SetBinContent(4,27.48829);
   n_jetsingap->SetBinContent(5,5.392942);
   n_jetsingap->SetBinContent(6,1.254764);
   n_jetsingap->SetBinError(1,20.22178);
   n_jetsingap->SetBinError(2,12.68283);
   n_jetsingap->SetBinError(3,6.742997);
   n_jetsingap->SetBinError(4,3.324448);
   n_jetsingap->SetBinError(5,1.400337);
   n_jetsingap->SetBinError(6,0.7246003);
   n_jetsingap->SetEntries(2045);
   n_jetsingap->SetStats(0);
   ...
   TH1F *n_jetsingap = new TH1F("n_jetsingap","n_jetsingap",50,0,50);
   n_jetsingap->SetBinContent(1,233.0076);
   n_jetsingap->SetBinContent(2,50.20128);
   n_jetsingap->SetBinContent(3,8.227835);
   n_jetsingap->SetBinContent(4,1.154463);
   n_jetsingap->SetBinContent(5,0.1023511);
   n_jetsingap->SetBinContent(6,0.05704633);
   n_jetsingap->SetBinError(1,2.150382);
   n_jetsingap->SetBinError(2,1.002578);
   n_jetsingap->SetBinError(3,0.4079752);
   n_jetsingap->SetBinError(4,0.1499162);
   n_jetsingap->SetBinError(5,0.04658256);
   n_jetsingap->SetBinError(6,0.03332236);
   n_jetsingap->SetEntries(17267);
   n_jetsingap->SetStats(0);
   ...
   TH1F *n_jetsingap = new TH1F("n_jetsingap","n_jetsingap",50,0,50);
   n_jetsingap->SetBinContent(2,0.1134007);
   n_jetsingap->SetBinError(2,0.1134007);
   ...
   TH1F *n_jetsingap = new TH1F("n_jetsingap","n_jetsingap",50,0,50);
   n_jetsingap->SetBinContent(1,6.225976);
   n_jetsingap->SetBinContent(2,5.503145);
   n_jetsingap->SetBinContent(3,2.740132);
   n_jetsingap->SetBinContent(4,0.4838676);
   n_jetsingap->SetBinContent(5,0.2241303);
   n_jetsingap->SetBinError(1,0.8853946);
   n_jetsingap->SetBinError(2,0.7612575);
   n_jetsingap->SetBinError(3,0.4930696);
   n_jetsingap->SetBinError(4,0.1971612);
   n_jetsingap->SetBinError(5,0.1609872);
   n_jetsingap->SetEntries(182);
   n_jetsingap->SetStats(0);
   n_jetsingap->SetFillColor(3);
   n_jetsingap->SetLineColor(3);
   n_jetsingap->SetLineWidth(2);
   ...
   TH1F *n_jetsingap = new TH1F("n_jetsingap","n_jetsingap",50,0,50);
   n_jetsingap->SetBinContent(1,1.956129);
   n_jetsingap->SetBinContent(2,1.245522);
   n_jetsingap->SetBinContent(3,0.2613603);
   n_jetsingap->SetBinContent(4,0.05662074);
   n_jetsingap->SetBinError(1,0.1119985);
   n_jetsingap->SetBinError(2,0.08855318);
   n_jetsingap->SetBinError(3,0.0391843);
   n_jetsingap->SetBinError(4,0.01914654);
   n_jetsingap->SetEntries(663);
   n_jetsingap->SetStats(0);
   n_jetsingap->SetFillColor(3);
   n_jetsingap->SetLineColor(3);
   n_jetsingap->SetLineWidth(2);
   ...
   TH1F *n_jetsingap = new TH1F("n_jetsingap","n_jetsingap",50,0,50);
   n_jetsingap->SetBinContent(1,533);
   n_jetsingap->SetBinContent(2,309);
   n_jetsingap->SetBinContent(3,150);
   n_jetsingap->SetBinContent(4,64);
   n_jetsingap->SetBinContent(5,24);
   n_jetsingap->SetBinContent(6,7);
   n_jetsingap->SetBinContent(7,4);
   n_jetsingap->SetBinError(1,23.08679);
   n_jetsingap->SetBinError(2,17.5784);
   n_jetsingap->SetBinError(3,12.24745);
   n_jetsingap->SetBinError(4,8);
   n_jetsingap->SetBinError(5,4.898979);
   n_jetsingap->SetBinError(6,2.645751);
   n_jetsingap->SetBinError(7,2);
   n_jetsingap->SetEntries(1091);
   n_jetsingap->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_jetsingap = new TH1F("n_jetsingap","n_jetsingap",50,0,50);
   n_jetsingap->SetBinContent(1,0.6889114);
   n_jetsingap->SetBinContent(2,0.7084479);
   n_jetsingap->SetBinContent(3,0.7144536);
   n_jetsingap->SetBinContent(4,0.7787411);
   n_jetsingap->SetBinContent(5,0.8152055);
   n_jetsingap->SetBinContent(6,0.6655081);
   n_jetsingap->SetBinContent(7,2.234249);
   n_jetsingap->SetBinError(1,0.03516922);
   n_jetsingap->SetBinError(2,0.04675952);
   n_jetsingap->SetBinError(3,0.06818085);
   n_jetsingap->SetBinError(4,0.11805);
   n_jetsingap->SetBinError(5,0.205225);
   n_jetsingap->SetBinError(6,0.3081564);
   n_jetsingap->SetBinError(7,1.945817);
   n_jetsingap->SetMinimum(0);
   n_jetsingap->SetMaximum(2);
   n_jetsingap->SetEntries(11.05948);
   n_jetsingap->SetStats(0);
   n_jetsingap->SetFillStyle(0);
   n_jetsingap->SetMarkerStyle(20);
   n_jetsingap->SetMarkerSize(0.8);

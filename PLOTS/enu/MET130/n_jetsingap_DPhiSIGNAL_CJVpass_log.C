...
// ------------>Primitives in pad: upper
   ...
   n_jetsingap_stack_14->SetBinContent(1,3.163637);
   n_jetsingap_stack_14->SetBinError(1,2.507133);
   n_jetsingap_stack_14->SetMinimum(0.001969375);
   n_jetsingap_stack_14->SetMaximum(3763959);
   n_jetsingap_stack_14->SetEntries(8);
...
// ------------>Primitives in pad: lower
   ...
   n_jetsingap->SetEntries(45.75302);
   n_jetsingap->SetStats(0);
   n_jetsingap->SetFillStyle(0);
   n_jetsingap->SetMarkerStyle(20);
   n_jetsingap->SetMarkerSize(0.8);

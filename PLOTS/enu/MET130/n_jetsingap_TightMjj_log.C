...
// ------------>Primitives in pad: upper
   ...
   n_jetsingap_stack_7->SetBinContent(1,8.272489);
   n_jetsingap_stack_7->SetBinContent(2,11.41572);
   n_jetsingap_stack_7->SetBinContent(3,0.1406795);
   n_jetsingap_stack_7->SetBinContent(6,0.05750282);
   n_jetsingap_stack_7->SetBinError(1,3.795149);
   n_jetsingap_stack_7->SetBinError(2,4.601989);
   n_jetsingap_stack_7->SetBinError(3,0.08432841);
   n_jetsingap_stack_7->SetBinError(6,0.05750282);
   n_jetsingap_stack_7->SetMinimum(0.001866402);
   n_jetsingap_stack_7->SetMaximum(1.4258e+07);
   n_jetsingap_stack_7->SetEntries(43);
...
// ------------>Primitives in pad: lower
   ...
   n_jetsingap->SetEntries(8.142873);
   n_jetsingap->SetStats(0);
   n_jetsingap->SetFillStyle(0);
   n_jetsingap->SetMarkerStyle(20);
   n_jetsingap->SetMarkerSize(0.8);

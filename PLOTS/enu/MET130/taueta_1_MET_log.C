...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-3.613924,-2.723504,3.348101,4.328048);
   ...
   taueta_1_stack_6->SetMinimum(0.002615335);
   taueta_1_stack_6->SetMaximum(9450.831);

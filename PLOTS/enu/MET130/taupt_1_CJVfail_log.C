...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-85.06329,-2.653703,446.5823,3.410778);
   ...
   taupt_1_stack_10->SetMinimum(0.002934854);
   taupt_1_stack_10->SetMaximum(1281.014);

...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-202.5316,-2.856877,1063.291,6.292249);
   ...
   stack->SetMaximum(274775.4);
   
   TH1F *jpt_2_stack_9 = new TH1F("jpt_2_stack_9","stack",25,0,1000);
   jpt_2_stack_9->SetBinContent(2,0.0739839);
   jpt_2_stack_9->SetBinContent(3,0.03584622);
   jpt_2_stack_9->SetBinContent(4,0.04163286);
   jpt_2_stack_9->SetBinError(2,0.05266004);
   jpt_2_stack_9->SetBinError(3,0.03584622);
   jpt_2_stack_9->SetBinError(4,0.04163286);
   jpt_2_stack_9->SetMinimum(0.002118874);
   jpt_2_stack_9->SetMaximum(683585);
   jpt_2_stack_9->SetEntries(4);
   ...
   jpt_2->SetBinContent(3,1.225155);
   jpt_2->SetBinError(2,1.299581);
   jpt_2->SetBinError(3,0.875929);
   jpt_2->SetEntries(5);
   jpt_2->SetStats(0);
   ...
   TH1F *jpt_2 = new TH1F("jpt_2","jpt_2",25,0,1000);
   jpt_2->SetBinContent(2,8.331432);
   jpt_2->SetBinContent(3,6.258859);
   jpt_2->SetBinContent(4,2.091032);
   jpt_2->SetBinContent(5,0.6100306);
   jpt_2->SetBinContent(6,0.07428867);
   jpt_2->SetBinError(2,1.030032);
   jpt_2->SetBinError(3,0.8477454);
   jpt_2->SetBinError(4,0.4931961);
   jpt_2->SetBinError(5,0.2475776);
   jpt_2->SetBinError(6,0.07428868);
   jpt_2->SetEntries(181);
   jpt_2->SetStats(0);
   jpt_2->SetFillColor(3);
   jpt_2->SetLineColor(3);
   jpt_2->SetLineWidth(2);
   ...
   TH1F *jpt_2 = new TH1F("jpt_2","jpt_2",25,0,1000);
   jpt_2->SetBinContent(2,7.663693);
   jpt_2->SetBinContent(3,6.324449);
   jpt_2->SetBinContent(4,2.766095);
   jpt_2->SetBinContent(5,1.476195);
   jpt_2->SetBinContent(6,0.3971852);
   jpt_2->SetBinContent(7,0.1146959);
   jpt_2->SetBinContent(8,0.1162074);
   jpt_2->SetBinContent(9,0.06475994);
   jpt_2->SetBinError(2,0.2862165);
   jpt_2->SetBinError(3,0.2604123);
   jpt_2->SetBinError(4,0.1686982);
   jpt_2->SetBinError(5,0.1287786);
   jpt_2->SetBinError(6,0.0633677);
   jpt_2->SetBinError(7,0.03590196);
   jpt_2->SetBinError(8,0.03539743);
   jpt_2->SetBinError(9,0.02807401);
   jpt_2->SetEntries(2263);
   jpt_2->SetStats(0);
   jpt_2->SetFillColor(3);
   jpt_2->SetLineColor(3);
   jpt_2->SetLineWidth(2);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *jpt_2 = new TH1F("jpt_2","jpt_2",25,0,1000);
   jpt_2->SetBinContent(2,0.6029255);
   jpt_2->SetBinContent(3,0.2172581);
   jpt_2->SetBinContent(4,0.6176492);
   jpt_2->SetBinContent(5,0.4793346);
   jpt_2->SetBinError(2,0.1901049);
   jpt_2->SetBinError(3,0.1269579);
   jpt_2->SetBinError(4,0.362708);
   jpt_2->SetBinError(5,0.4836041);
   jpt_2->SetMinimum(0);
   jpt_2->SetMaximum(2);
   jpt_2->SetEntries(8.799701);
   jpt_2->SetStats(0);
   jpt_2->SetFillStyle(0);
   jpt_2->SetMarkerStyle(20);
   jpt_2->SetMarkerSize(0.8);

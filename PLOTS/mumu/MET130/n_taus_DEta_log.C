...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.683603,6.379747,3.79454);
   ...
   stack->SetMaximum(1454.112);
   
   TH1F *n_taus_stack_5 = new TH1F("n_taus_stack_5","stack",10,0,10);
   n_taus_stack_5->SetBinContent(1,4.417217);
   n_taus_stack_5->SetBinContent(2,0.06136958);
   n_taus_stack_5->SetBinError(1,0.4911283);
   n_taus_stack_5->SetBinError(2,0.03694643);
   n_taus_stack_5->SetMinimum(0.002792283);
   n_taus_stack_5->SetMaximum(2955.512);
   n_taus_stack_5->SetEntries(125);
   ...
   n_taus->SetBinContent(1,4.417217);
   n_taus->SetBinContent(2,0.06136958);
   n_taus->SetBinError(1,0.4911283);
   n_taus->SetBinError(2,0.03694643);
   n_taus->SetMinimum(0.01);
   n_taus->SetMaximum(1041);
   n_taus->SetEntries(125);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,32.86993);
   n_taus->SetBinContent(2,0.30348);
   n_taus->SetBinError(1,4.453619);
   n_taus->SetBinError(2,0.30348);
   n_taus->SetEntries(78);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,269.4742);
   n_taus->SetBinContent(2,0.90263);
   n_taus->SetBinError(1,5.272893);
   n_taus->SetBinError(2,0.3197135);
   n_taus->SetEntries(3913);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,177.9427);
   n_taus->SetBinContent(2,0.5108705);
   n_taus->SetBinError(1,1.288251);
   n_taus->SetBinError(2,0.06521388);
   n_taus->SetEntries(27040);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,347);
   n_taus->SetBinContent(2,3);
   n_taus->SetBinError(1,18.62794);
   n_taus->SetBinError(2,1.732051);
   n_taus->SetEntries(350);
   n_taus->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,0.7224848);
   n_taus->SetBinContent(2,1.747253);
   n_taus->SetBinError(1,0.0401974);
   n_taus->SetBinError(2,1.106013);
   n_taus->SetMinimum(0);
   n_taus->SetMaximum(2);
   n_taus->SetEntries(4.979755);
   n_taus->SetStats(0);
   n_taus->SetFillStyle(0);
   n_taus->SetMarkerStyle(20);
   n_taus->SetMarkerSize(0.8);

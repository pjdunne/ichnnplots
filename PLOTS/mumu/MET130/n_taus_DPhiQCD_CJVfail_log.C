...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.542894,6.379747,2.105547);
   ...
   stack->SetMaximum(43.23075);
   
   TH1F *n_taus_stack_12 = new TH1F("n_taus_stack_12","stack",10,0,10);
   n_taus_stack_12->SetBinContent(1,0.1102124);
   n_taus_stack_12->SetBinError(1,0.0639509);
   n_taus_stack_12->SetMinimum(0.003548747);
   n_taus_stack_12->SetMaximum(74.66636);
   n_taus_stack_12->SetEntries(3);
   ...
   n_taus->SetBinContent(1,0.1102124);
   n_taus->SetBinError(1,0.0639509);
   n_taus->SetMinimum(0.01);
   n_taus->SetMaximum(39);
   n_taus->SetEntries(3);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,2.953339);
   n_taus->SetBinError(1,1.478057);
   n_taus->SetEntries(4);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,7.809301);
   n_taus->SetBinError(1,0.8630975);
   n_taus->SetEntries(95);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,3.537398);
   n_taus->SetBinContent(2,0.02054582);
   n_taus->SetBinError(1,0.1951529);
   n_taus->SetBinError(2,0.01528469);
   n_taus->SetEntries(424);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,13);
   n_taus->SetBinError(1,3.605551);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,0.9090885);
   n_taus->SetBinError(1,0.274893);
   n_taus->SetMinimum(0);
   n_taus->SetMaximum(2);
   n_taus->SetEntries(10.93666);
   n_taus->SetStats(0);
   n_taus->SetFillStyle(0);
   n_taus->SetMarkerStyle(20);
   n_taus->SetMarkerSize(0.8);

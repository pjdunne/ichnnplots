...
// ------------>Primitives in pad: upper
   ...
   n_taus_stack_9->SetBinContent(1,0.151463);
   n_taus_stack_9->SetBinError(1,0.07610076);
   n_taus_stack_9->SetMinimum(0.003291201);
   n_taus_stack_9->SetMaximum(216.6571);
   n_taus_stack_9->SetEntries(4);

...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.555384,6.379747,2.243641);
   ...
   stack->SetMaximum(57.56362);
   
   TH1F *n_taus_stack_11 = new TH1F("n_taus_stack_11","stack",10,0,10);
   n_taus_stack_11->SetBinContent(1,0.3749764);
   n_taus_stack_11->SetBinError(1,0.1606805);
   n_taus_stack_11->SetMinimum(0.003472133);
   n_taus_stack_11->SetMaximum(100.8532);
   n_taus_stack_11->SetEntries(6);
   ...
   n_taus->SetBinContent(1,0.3749764);
   n_taus->SetBinError(1,0.1606805);
   n_taus->SetMinimum(0.01);
   n_taus->SetMaximum(33);
   n_taus->SetEntries(6);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,4.907032);
   n_taus->SetBinError(1,2.058181);
   n_taus->SetEntries(7);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,10.7054);
   n_taus->SetBinError(1,1.029926);
   n_taus->SetEntries(128);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,3.200464);
   n_taus->SetBinContent(2,0.02339373);
   n_taus->SetBinError(1,0.1871487);
   n_taus->SetBinError(2,0.01336095);
   n_taus->SetEntries(372);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,11);
   n_taus->SetBinError(1,3.316625);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,0.5847053);
   n_taus->SetBinError(1,0.190343);
   n_taus->SetMinimum(0);
   n_taus->SetMaximum(2);
   n_taus->SetEntries(9.436269);
   n_taus->SetStats(0);
   n_taus->SetFillStyle(0);
   n_taus->SetMarkerStyle(20);
   n_taus->SetMarkerSize(0.8);

...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.593768,6.379747,2.682233);
   ...
   stack->SetMaximum(143.1234);
   
   TH1F *n_taus_stack_8 = new TH1F("n_taus_stack_8","stack",10,0,10);
   n_taus_stack_8->SetBinContent(1,0.6007318);
   n_taus_stack_8->SetBinError(1,0.1996859);
   n_taus_stack_8->SetMinimum(0.003249016);
   n_taus_stack_8->SetMaximum(262.0792);
   n_taus_stack_8->SetEntries(10);
   ...
   n_taus->SetBinContent(1,0.6007318);
   n_taus->SetBinError(1,0.1996859);
   n_taus->SetMinimum(0.01);
   n_taus->SetMaximum(81);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,25.78387);
   n_taus->SetBinError(1,1.798753);
   n_taus->SetEntries(259);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,16.41615);
   n_taus->SetBinContent(2,0.0489629);
   n_taus->SetBinError(1,0.4194802);
   n_taus->SetBinError(2,0.02049239);
   n_taus->SetEntries(1961);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,27);
   n_taus->SetBinError(1,5.196152);
   n_taus->SetEntries(27);
   n_taus->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,0.5731626);
   n_taus->SetBinError(1,0.115323);
   n_taus->SetMinimum(0);
   n_taus->SetMaximum(2);
   n_taus->SetEntries(24.70152);
   n_taus->SetStats(0);
   n_taus->SetFillStyle(0);
   n_taus->SetMarkerStyle(20);
   n_taus->SetMarkerSize(0.8);

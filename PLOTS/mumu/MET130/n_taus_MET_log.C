...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.668852,6.379747,3.603499);
   ...
   stack->SetMaximum(975.6979);
   
   TH1F *n_taus_stack_6 = new TH1F("n_taus_stack_6","stack",10,0,10);
   n_taus_stack_6->SetBinContent(1,3.279264);
   n_taus_stack_6->SetBinContent(2,0.02820505);
   n_taus_stack_6->SetBinError(1,0.4330378);
   n_taus_stack_6->SetBinError(2,0.02820505);
   n_taus_stack_6->SetMinimum(0.002861511);
   n_taus_stack_6->SetMaximum(1949.311);
   n_taus_stack_6->SetEntries(79);
   ...
   n_taus->SetBinContent(1,3.279264);
   n_taus->SetBinContent(2,0.02820505);
   n_taus->SetBinError(1,0.4330378);
   n_taus->SetBinError(2,0.02820505);
   n_taus->SetMinimum(0.01);
   n_taus->SetMaximum(624);
   n_taus->SetEntries(79);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,22.9176);
   n_taus->SetBinError(1,3.86682);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,180.2574);
   n_taus->SetBinContent(2,0.5365363);
   n_taus->SetBinError(1,4.530724);
   n_taus->SetBinError(2,0.2707017);
   n_taus->SetEntries(2197);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,118.7784);
   n_taus->SetBinContent(2,0.2664973);
   n_taus->SetBinError(1,1.115807);
   n_taus->SetBinError(2,0.05000112);
   n_taus->SetEntries(14986);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,208);
   n_taus->SetBinContent(2,3);
   n_taus->SetBinError(1,14.42221);
   n_taus->SetBinError(2,1.732051);
   n_taus->SetEntries(211);
   n_taus->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,0.6460563);
   n_taus->SetBinContent(2,3.735833);
   n_taus->SetBinError(1,0.04641722);
   n_taus->SetBinError(2,2.508427);
   n_taus->SetMinimum(0);
   n_taus->SetMaximum(2);
   n_taus->SetEntries(3.0505);
   n_taus->SetStats(0);
   n_taus->SetFillStyle(0);
   n_taus->SetMarkerStyle(20);
   n_taus->SetMarkerSize(0.8);

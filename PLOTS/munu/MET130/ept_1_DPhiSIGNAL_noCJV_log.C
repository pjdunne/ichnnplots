...
// ------------>Primitives in pad: upper
   ...
   TH1F *ept_1_stack_8 = new TH1F("ept_1_stack_8","stack",25,0,1000);
   ept_1_stack_8->SetBinContent(0,17.79839);
   ept_1_stack_8->SetBinError(0,5.129113);
   ept_1_stack_8->SetMinimum(-0);
   ept_1_stack_8->SetMaximum(nan);
   ept_1_stack_8->SetEntries(49);
   ept_1_stack_8->SetStats(0);
   ept_1_stack_8->SetFillColor(4);
   ept_1_stack_8->SetLineColor(4);
   ept_1_stack_8->SetLineWidth(2);
   ept_1_stack_8->SetMarkerColor(4);
   ept_1_stack_8->SetMarkerStyle(21);
   ept_1_stack_8->SetMarkerSize(0.8);
   ept_1_stack_8->GetXaxis()->SetTitle("Leading electron p_{T} [GeV]");
   ept_1_stack_8->GetXaxis()->SetRange(1,11);
   ept_1_stack_8->GetXaxis()->SetLabelFont(42);
   ept_1_stack_8->GetXaxis()->SetLabelOffset(0.007);
   ept_1_stack_8->GetXaxis()->SetLabelSize(0);
   ept_1_stack_8->GetXaxis()->SetTitleSize(0);
   ept_1_stack_8->GetXaxis()->SetTickLength(0.02);
   ept_1_stack_8->GetXaxis()->SetTitleOffset(0.9);
   ept_1_stack_8->GetXaxis()->SetTitleFont(42);
   ept_1_stack_8->GetYaxis()->SetTitle("Events");
   ept_1_stack_8->GetYaxis()->SetLabelFont(42);
   ept_1_stack_8->GetYaxis()->SetLabelOffset(0.007);
   ept_1_stack_8->GetYaxis()->SetLabelSize(0.035);
   ept_1_stack_8->GetYaxis()->SetTitleSize(0.045);
   ept_1_stack_8->GetYaxis()->SetTickLength(0.02);
   ept_1_stack_8->GetYaxis()->SetTitleOffset(1.55);
   ept_1_stack_8->GetYaxis()->SetTitleFont(42);
   ept_1_stack_8->GetZaxis()->SetLabelFont(42);
   ept_1_stack_8->GetZaxis()->SetLabelOffset(0.007);
   ept_1_stack_8->GetZaxis()->SetLabelSize(0.035);
   ept_1_stack_8->GetZaxis()->SetTitleSize(0.045);
   ept_1_stack_8->GetZaxis()->SetTickLength(0.02);
   ept_1_stack_8->GetZaxis()->SetTitleFont(42);
   stack->SetHistogram(ept_1_stack_8);
   
   
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,17.79839);
   ept_1->SetBinError(0,5.129113);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,90.96423);
   ept_1->SetBinError(0,7.983399);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,397.6176);
   ept_1->SetBinError(0,18.30546);
   ept_1->SetEntries(732);
   ept_1->SetStats(0);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,106.9574);
   ept_1->SetBinError(0,1.485231);
   ept_1->SetEntries(5990);
   ept_1->SetStats(0);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,16.76759);
   ept_1->SetBinError(0,1.534446);
   ept_1->SetEntries(174);
   ept_1->SetStats(0);
   ept_1->SetFillColor(3);
   ept_1->SetLineColor(3);
   ept_1->SetLineWidth(2);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,4.443465);
   ept_1->SetBinError(0,0.2086785);
   ept_1->SetEntries(592);
   ept_1->SetStats(0);
   ept_1->SetFillColor(3);
   ept_1->SetLineColor(3);
   ept_1->SetLineWidth(2);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,432);
   ept_1->SetBinError(0,20.78461);
   ept_1->SetEntries(432);
   ept_1->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,0.7004455);
   ept_1->SetBinError(0,0.04069465);
   ept_1->SetMinimum(0);
   ept_1->SetMaximum(2);
   ept_1->SetStats(0);
   ept_1->SetFillStyle(0);

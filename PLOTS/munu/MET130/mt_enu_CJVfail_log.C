...
// ------------>Primitives in pad: upper
   ...
   mt_enu_stack_10->SetBinContent(0,37.88433);
   mt_enu_stack_10->SetBinError(0,8.066901);
   mt_enu_stack_10->SetMinimum(-0);
   mt_enu_stack_10->SetMaximum(nan);
   mt_enu_stack_10->SetEntries(83);
   ...
   mt_enu->SetBinContent(0,37.88433);
   mt_enu->SetBinError(0,8.066901);
   mt_enu->SetMinimum(0.01);
   mt_enu->SetMaximum(0);
   mt_enu->SetEntries(83);
   mt_enu->SetStats(0);
   ...
   TH1F *mt_enu = new TH1F("mt_enu","mt_enu",25,0,500);
   mt_enu->SetBinContent(0,273.9654);
   mt_enu->SetBinError(0,13.99535);
   ...
   TH1F *mt_enu = new TH1F("mt_enu","mt_enu",25,0,500);
   mt_enu->SetBinContent(0,799.0107);
   mt_enu->SetBinError(0,21.25602);
   mt_enu->SetEntries(1848);
   mt_enu->SetStats(0);
   ...
   TH1F *mt_enu = new TH1F("mt_enu","mt_enu",25,0,500);
   mt_enu->SetBinContent(0,113.0519);
   mt_enu->SetBinError(0,1.522487);
   mt_enu->SetEntries(6349);
   mt_enu->SetStats(0);
   ...
   TH1F *mt_enu = new TH1F("mt_enu","mt_enu",25,0,500);
   mt_enu->SetBinContent(0,43.89109);
   mt_enu->SetBinError(0,2.256885);
   mt_enu->SetEntries(519);
   mt_enu->SetStats(0);
   mt_enu->SetFillColor(3);
   mt_enu->SetLineColor(3);
   mt_enu->SetLineWidth(2);
   ...
   TH1F *mt_enu = new TH1F("mt_enu","mt_enu",25,0,500);
   mt_enu->SetBinContent(0,10.58986);
   mt_enu->SetBinError(0,0.3188715);
   mt_enu->SetEntries(1413);
   mt_enu->SetStats(0);
   mt_enu->SetFillColor(3);
   mt_enu->SetLineColor(3);
   mt_enu->SetLineWidth(2);
   ...
   TH1F *mt_enu = new TH1F("mt_enu","mt_enu",25,0,500);
   mt_enu->SetBinContent(0,1013);
   mt_enu->SetBinError(0,31.82766);
   mt_enu->SetEntries(1013);
   mt_enu->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *mt_enu = new TH1F("mt_enu","mt_enu",25,0,500);
   mt_enu->SetBinContent(0,0.8166003);
   mt_enu->SetBinError(0,0.03069523);
   mt_enu->SetMinimum(0);
   mt_enu->SetMaximum(2);
   mt_enu->SetStats(0);
   mt_enu->SetFillStyle(0);

...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-85.06329,-2.916278,446.5823,7.257826);
   ...
   stack->SetMaximum(2106072);
   
   TH1F *mt_munu_stack_14 = new TH1F("mt_munu_stack_14","stack",25,0,500);
   mt_munu_stack_14->SetBinContent(1,2.567365);
   mt_munu_stack_14->SetBinContent(2,2.296211);
   mt_munu_stack_14->SetBinContent(3,4.115188);
   mt_munu_stack_14->SetBinContent(4,6.135144);
   mt_munu_stack_14->SetBinContent(5,2.484224);
   mt_munu_stack_14->SetBinContent(6,0.1227986);
   mt_munu_stack_14->SetBinContent(7,0.07745969);
   mt_munu_stack_14->SetBinError(1,2.226169);
   mt_munu_stack_14->SetBinError(2,1.07091);
   mt_munu_stack_14->SetBinError(3,2.350341);
   mt_munu_stack_14->SetBinError(4,3.250885);
   mt_munu_stack_14->SetBinError(5,2.024635);
   mt_munu_stack_14->SetBinError(6,0.08728389);
   mt_munu_stack_14->SetBinError(7,0.07745969);
   mt_munu_stack_14->SetMinimum(0.001937332);
   mt_munu_stack_14->SetMaximum(5612038);
   mt_munu_stack_14->SetEntries(49);

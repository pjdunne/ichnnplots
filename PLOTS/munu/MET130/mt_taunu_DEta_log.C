...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-85.06329,-2.836972,446.5823,5.98124);
   ...
   mt_taunu_stack_5->SetMinimum(0.002184704);
   mt_taunu_stack_5->SetMaximum(346999.7);

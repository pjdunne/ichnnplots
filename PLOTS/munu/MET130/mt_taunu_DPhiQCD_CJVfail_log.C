...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-85.06329,-2.768607,446.5823,4.960935);
   ...
   mt_taunu_stack_12->SetMinimum(0.002432112);
   mt_taunu_stack_12->SetMaximum(37536.82);

...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-85.06329,-2.791558,446.5823,5.295233);
   ...
   stack->SetMaximum(33736.89);
   
   TH1F *mt_taunu_stack_11 = new TH1F("mt_taunu_stack_11","stack",25,0,500);
   mt_taunu_stack_11->SetBinContent(0,9.408665);
   mt_taunu_stack_11->SetBinError(0,3.635236);
   mt_taunu_stack_11->SetMinimum(0.002345187);
   mt_taunu_stack_11->SetMaximum(77784.49);
   mt_taunu_stack_11->SetEntries(22);
   ...
   mt_taunu->SetBinContent(0,9.408665);
   mt_taunu->SetBinError(0,3.635236);
   ...
   TH1F *mt_taunu = new TH1F("mt_taunu","mt_taunu",25,0,500);
   mt_taunu->SetBinContent(0,179.6671);
   mt_taunu->SetBinError(0,10.03612);
   mt_taunu->SetEntries(411);
   mt_taunu->SetStats(0);
   ...
   TH1F *mt_taunu = new TH1F("mt_taunu","mt_taunu",25,0,500);
   mt_taunu->SetBinContent(0,1.339353);
   mt_taunu->SetBinContent(1,0.05156582);
   mt_taunu->SetBinContent(2,0.01830857);
   mt_taunu->SetBinContent(3,0.03257165);
   mt_taunu->SetBinContent(4,0.01835481);
   mt_taunu->SetBinContent(9,0.006837361);
   mt_taunu->SetBinContent(21,0.006762422);
   mt_taunu->SetBinError(0,0.114446);
   mt_taunu->SetBinError(1,0.01770286);
   mt_taunu->SetBinError(2,0.01058118);
   mt_taunu->SetBinError(3,0.01463976);
   mt_taunu->SetBinError(4,0.0129855);
   mt_taunu->SetBinError(9,0.006837361);
   mt_taunu->SetBinError(21,0.006762422);
   mt_taunu->SetEntries(198);
   mt_taunu->SetStats(0);
   mt_taunu->SetFillColor(3);
   mt_taunu->SetLineColor(3);
   mt_taunu->SetLineWidth(2);
   ...
   TH1F *mt_taunu = new TH1F("mt_taunu","mt_taunu",25,0,500);
   mt_taunu->SetBinContent(0,215);
   mt_taunu->SetBinContent(2,1);
   mt_taunu->SetBinError(0,14.66288);
   mt_taunu->SetBinError(2,1);
   mt_taunu->SetEntries(216);
   mt_taunu->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *mt_taunu = new TH1F("mt_taunu","mt_taunu",25,0,500);
   mt_taunu->SetBinContent(0,0.755316);
   mt_taunu->SetBinContent(2,0.4446171);
   mt_taunu->SetBinError(0,0.06132263);
   mt_taunu->SetBinError(2,0.5128694);
   mt_taunu->SetMinimum(0);
   mt_taunu->SetMaximum(2);
   mt_taunu->SetEntries(0.7515516);
   mt_taunu->SetStats(0);
   mt_taunu->SetFillStyle(0);
   mt_taunu->SetMarkerStyle(20);
   mt_taunu->SetMarkerSize(0.8);

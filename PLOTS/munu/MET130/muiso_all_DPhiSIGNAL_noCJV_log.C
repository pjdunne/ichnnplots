...
// ------------>Primitives in pad: upper
   ...
   TH1F *muiso_all_stack_8 = new TH1F("muiso_all_stack_8","stack",100,0,2);
   muiso_all_stack_8->SetBinContent(1,9.941998);
   muiso_all_stack_8->SetBinContent(2,3.082855);
   muiso_all_stack_8->SetBinContent(3,1.713293);
   muiso_all_stack_8->SetBinContent(4,2.082297);
   muiso_all_stack_8->SetBinContent(5,0.1128355);
   muiso_all_stack_8->SetBinContent(6,0.8651122);
   muiso_all_stack_8->SetBinError(1,3.704788);
   muiso_all_stack_8->SetBinError(2,2.318494);
   muiso_all_stack_8->SetBinError(3,1.644159);
   muiso_all_stack_8->SetBinError(4,1.966644);
   muiso_all_stack_8->SetBinError(5,0.07984626);
   muiso_all_stack_8->SetBinError(6,0.7934831);
   muiso_all_stack_8->SetMinimum(0.001843464);
   muiso_all_stack_8->SetMaximum(1.957013e+07);
   muiso_all_stack_8->SetEntries(49);
   muiso_all_stack_8->SetStats(0);
   muiso_all_stack_8->SetFillColor(4);
   muiso_all_stack_8->SetLineColor(4);
   muiso_all_stack_8->SetLineWidth(2);
   muiso_all_stack_8->SetMarkerColor(4);
   muiso_all_stack_8->SetMarkerStyle(21);
   muiso_all_stack_8->SetMarkerSize(0.8);
   muiso_all_stack_8->GetXaxis()->SetTitle("Muon iso");
   muiso_all_stack_8->GetXaxis()->SetLabelFont(42);
   muiso_all_stack_8->GetXaxis()->SetLabelOffset(0.007);
   muiso_all_stack_8->GetXaxis()->SetLabelSize(0);
   muiso_all_stack_8->GetXaxis()->SetTitleSize(0);
   muiso_all_stack_8->GetXaxis()->SetTickLength(0.02);
   muiso_all_stack_8->GetXaxis()->SetTitleOffset(0.9);
   muiso_all_stack_8->GetXaxis()->SetTitleFont(42);
   muiso_all_stack_8->GetYaxis()->SetTitle("Events");
   muiso_all_stack_8->GetYaxis()->SetLabelFont(42);
   muiso_all_stack_8->GetYaxis()->SetLabelOffset(0.007);
   muiso_all_stack_8->GetYaxis()->SetLabelSize(0.035);
   muiso_all_stack_8->GetYaxis()->SetTitleSize(0.045);
   muiso_all_stack_8->GetYaxis()->SetTickLength(0.02);
   muiso_all_stack_8->GetYaxis()->SetTitleOffset(1.55);
   muiso_all_stack_8->GetYaxis()->SetTitleFont(42);
   muiso_all_stack_8->GetZaxis()->SetLabelFont(42);
   muiso_all_stack_8->GetZaxis()->SetLabelOffset(0.007);
   muiso_all_stack_8->GetZaxis()->SetLabelSize(0.035);
   muiso_all_stack_8->GetZaxis()->SetTitleSize(0.045);
   muiso_all_stack_8->GetZaxis()->SetTickLength(0.02);
   muiso_all_stack_8->GetZaxis()->SetTitleFont(42);
   stack->SetHistogram(muiso_all_stack_8);

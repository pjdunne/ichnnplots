...
// ------------>Primitives in pad: upper
   ...
   TH1F *n_electrons_stack_9 = new TH1F("n_electrons_stack_9","stack",10,0,10);
   n_electrons_stack_9->SetBinContent(1,15.86491);
   n_electrons_stack_9->SetBinError(1,5.728998);
   n_electrons_stack_9->SetMinimum(0.001840094);
   n_electrons_stack_9->SetMaximum(2.051579e+07);
   n_electrons_stack_9->SetEntries(25);
   n_electrons_stack_9->SetStats(0);
   n_electrons_stack_9->SetFillColor(4);
   n_electrons_stack_9->SetLineColor(4);
   n_electrons_stack_9->SetLineWidth(2);
   n_electrons_stack_9->SetMarkerColor(4);
   n_electrons_stack_9->SetMarkerStyle(21);
   n_electrons_stack_9->SetMarkerSize(0.8);
   n_electrons_stack_9->GetXaxis()->SetTitle("Number of electrons");
   n_electrons_stack_9->GetXaxis()->SetRange(1,6);
   n_electrons_stack_9->GetXaxis()->SetLabelFont(42);
   n_electrons_stack_9->GetXaxis()->SetLabelOffset(0.007);
   n_electrons_stack_9->GetXaxis()->SetLabelSize(0);
   n_electrons_stack_9->GetXaxis()->SetTitleSize(0);
   n_electrons_stack_9->GetXaxis()->SetTickLength(0.02);
   n_electrons_stack_9->GetXaxis()->SetTitleOffset(0.9);
   n_electrons_stack_9->GetXaxis()->SetTitleFont(42);
   n_electrons_stack_9->GetYaxis()->SetTitle("Events");
   n_electrons_stack_9->GetYaxis()->SetLabelFont(42);
   n_electrons_stack_9->GetYaxis()->SetLabelOffset(0.007);
   n_electrons_stack_9->GetYaxis()->SetLabelSize(0.035);
   n_electrons_stack_9->GetYaxis()->SetTitleSize(0.045);
   n_electrons_stack_9->GetYaxis()->SetTickLength(0.02);
   n_electrons_stack_9->GetYaxis()->SetTitleOffset(1.55);
   n_electrons_stack_9->GetYaxis()->SetTitleFont(42);
   n_electrons_stack_9->GetZaxis()->SetLabelFont(42);
   n_electrons_stack_9->GetZaxis()->SetLabelOffset(0.007);
   n_electrons_stack_9->GetZaxis()->SetLabelSize(0.035);
   n_electrons_stack_9->GetZaxis()->SetTitleSize(0.045);
   n_electrons_stack_9->GetZaxis()->SetTickLength(0.02);
   n_electrons_stack_9->GetZaxis()->SetTitleFont(42);
   stack->SetHistogram(n_electrons_stack_9);

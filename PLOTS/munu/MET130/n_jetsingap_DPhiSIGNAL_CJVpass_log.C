...
// ------------>Primitives in pad: upper
   ...
   n_jetsingap_stack_14->SetBinContent(1,8.389728);
   n_jetsingap_stack_14->SetBinError(1,3.618406);
   n_jetsingap_stack_14->SetMinimum(0.001868682);
   n_jetsingap_stack_14->SetMaximum(1.38219e+07);
   n_jetsingap_stack_14->SetEntries(27);
...
// ------------>Primitives in pad: lower
   ...
   n_jetsingap->SetEntries(145.081);
   n_jetsingap->SetStats(0);
   n_jetsingap->SetFillStyle(0);
   n_jetsingap->SetMarkerStyle(20);
   n_jetsingap->SetMarkerSize(0.8);

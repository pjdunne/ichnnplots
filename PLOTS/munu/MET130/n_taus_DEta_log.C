...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.776791,6.379747,5.079184);
   ...
   stack->SetMaximum(21433.05);
   
   TH1F *n_taus_stack_5 = new TH1F("n_taus_stack_5","stack",10,0,10);
   n_taus_stack_5->SetBinContent(1,194.4124);
   n_taus_stack_5->SetBinContent(2,0.8792668);
   n_taus_stack_5->SetBinError(1,16.72038);
   n_taus_stack_5->SetBinError(2,0.5809235);
   n_taus_stack_5->SetMinimum(0.002400648);
   n_taus_stack_5->SetMaximum(48571.94);
   n_taus_stack_5->SetEntries(812);
   ...
   n_taus->SetBinContent(1,194.4124);
   n_taus->SetBinContent(2,0.8792668);
   n_taus->SetBinError(1,16.72038);
   n_taus->SetBinError(2,0.5809235);
   n_taus->SetMinimum(0.01);
   n_taus->SetMaximum(17892);
   n_taus->SetEntries(812);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,758.6837);
   n_taus->SetBinContent(2,15.99204);
   n_taus->SetBinError(1,20.39006);
   n_taus->SetBinError(2,3.353212);
   n_taus->SetEntries(2229);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,4650.125);
   n_taus->SetBinContent(2,25.38522);
   n_taus->SetBinError(1,54.16156);
   n_taus->SetBinError(2,4.076293);
   n_taus->SetEntries(12858);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,1136.153);
   n_taus->SetBinContent(2,3.107676);
   n_taus->SetBinError(1,4.443887);
   n_taus->SetBinError(2,0.224349);
   n_taus->SetEntries(83601);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,0.05156378);
   n_taus->SetBinError(1,0.05156378);
   n_taus->SetEntries(1);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,326.4999);
   n_taus->SetBinContent(2,8.562973);
   n_taus->SetBinError(1,5.649262);
   n_taus->SetBinError(2,0.9262583);
   n_taus->SetEntries(5525);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,78.4236);
   n_taus->SetBinContent(2,1.739421);
   n_taus->SetBinError(1,0.8049842);
   n_taus->SetBinError(2,0.1009836);
   n_taus->SetEntries(14070);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,5964);
   n_taus->SetBinContent(2,43);
   n_taus->SetBinError(1,77.22694);
   n_taus->SetBinError(2,6.557439);
   n_taus->SetEntries(6007);
   n_taus->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,0.8581372);
   n_taus->SetBinContent(2,0.784853);
   n_taus->SetBinError(1,0.01324136);
   n_taus->SetBinError(2,0.142237);
   n_taus->SetMinimum(0);
   n_taus->SetMaximum(2);
   n_taus->SetEntries(132.2809);
   n_taus->SetStats(0);
   n_taus->SetFillStyle(0);
   n_taus->SetMarkerStyle(20);
   n_taus->SetMarkerSize(0.8);

...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.760746,6.379747,4.84834);
   ...
   stack->SetMaximum(13204.53);
   
   TH1F *n_taus_stack_6 = new TH1F("n_taus_stack_6","stack",10,0,10);
   n_taus_stack_6->SetBinContent(1,130.4877);
   n_taus_stack_6->SetBinContent(2,0.215808);
   n_taus_stack_6->SetBinError(1,14.57759);
   n_taus_stack_6->SetBinError(2,0.1380019);
   n_taus_stack_6->SetMinimum(0.002462835);
   n_taus_stack_6->SetMaximum(29368.79);
   n_taus_stack_6->SetEntries(450);
   ...
   n_taus->SetBinContent(1,130.4877);
   n_taus->SetBinContent(2,0.215808);
   n_taus->SetBinError(1,14.57759);
   n_taus->SetBinError(2,0.1380019);
   n_taus->SetMinimum(0.01);
   n_taus->SetMaximum(9927);
   n_taus->SetEntries(450);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,509.4727);
   n_taus->SetBinContent(2,11.08054);
   n_taus->SetBinError(1,17.90337);
   n_taus->SetBinError(2,2.930069);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,2843.088);
   n_taus->SetBinContent(2,16.93569);
   n_taus->SetBinError(1,45.11799);
   n_taus->SetBinError(2,3.661849);
   n_taus->SetEntries(6393);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,738.2428);
   n_taus->SetBinContent(2,1.663925);
   n_taus->SetBinError(1,3.814666);
   n_taus->SetBinError(2,0.177281);
   n_taus->SetEntries(44506);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,138.6145);
   n_taus->SetBinContent(2,4.703916);
   n_taus->SetBinError(1,3.988155);
   n_taus->SetBinError(2,0.7752024);
   n_taus->SetEntries(1811);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,41.60503);
   n_taus->SetBinContent(2,1.017604);
   n_taus->SetBinError(1,0.6347543);
   n_taus->SetBinError(2,0.08310335);
   n_taus->SetEntries(5927);
   n_taus->SetStats(0);
   n_taus->SetFillColor(3);
   n_taus->SetLineColor(3);
   n_taus->SetLineWidth(2);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,3309);
   n_taus->SetBinContent(2,25);
   n_taus->SetBinError(1,57.52391);
   n_taus->SetBinError(2,5);
   n_taus->SetEntries(3334);
   n_taus->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,0.774756);
   n_taus->SetBinContent(2,0.7061814);
   n_taus->SetBinError(1,0.01612278);
   n_taus->SetBinError(2,0.1701584);
   n_taus->SetMinimum(0);
   n_taus->SetMaximum(2);
   n_taus->SetEntries(75.07322);
   n_taus->SetStats(0);
   n_taus->SetFillStyle(0);
   n_taus->SetMarkerStyle(20);
   n_taus->SetMarkerSize(0.8);

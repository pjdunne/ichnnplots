...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.053165,-2.906359,5.529114,7.092675);
   ...
   detajj_stack_15->SetMinimum(0.001966174);
   detajj_stack_15->SetMaximum(3914924);

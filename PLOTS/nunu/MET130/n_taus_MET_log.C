...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.780981,6.379747,5.14014);
   ...
   stack->SetMaximum(24358.89);
   
   TH1F *n_taus_stack_5 = new TH1F("n_taus_stack_5","stack",10,0,10);
   n_taus_stack_5->SetBinContent(1,178.9182);
   n_taus_stack_5->SetBinContent(2,6.251138);
   n_taus_stack_5->SetBinError(1,15.91033);
   n_taus_stack_5->SetBinError(2,3.051512);
   n_taus_stack_5->SetMinimum(0.00238474);
   n_taus_stack_5->SetMaximum(55473.26);
   n_taus_stack_5->SetEntries(1162);
   ...
   n_taus->SetBinContent(1,178.9182);
   n_taus->SetBinContent(2,6.251138);
   n_taus->SetBinError(1,15.91033);
   n_taus->SetBinError(2,3.051512);
   n_taus->SetMinimum(0.01);
   n_taus->SetMaximum(48102);
   n_taus->SetEntries(1162);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,442.5567);
   n_taus->SetBinContent(2,40.09555);
   n_taus->SetBinError(1,16.66732);
   n_taus->SetBinError(2,4.919438);
   n_taus->SetEntries(1113);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,4129.936);
   n_taus->SetBinContent(2,144.4551);
   n_taus->SetBinError(1,53.58708);
   n_taus->SetBinError(2,9.875831);
   n_taus->SetEntries(9626);
   n_taus->SetStats(0);
   ...
   TH1F *n_taus = new TH1F("n_taus","n_taus",10,0,10);
   n_taus->SetBinContent(1,873.4026);
   n_taus->SetBinContent(2,2.087515);
   n_taus->SetBinError(1,17.33773);
   n_taus->SetBinError(2,0.7844039);
   n_taus->SetEntries(3051);
   n_taus->SetStats(0);
   n_taus->SetFillColor(1);
   n_taus->SetFillStyle(0);

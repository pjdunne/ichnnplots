...
// ------------>Primitives in pad: upper
   ...
   ept_1_stack_5->SetBinContent(0,10.86905);
   ept_1_stack_5->SetBinError(0,3.719117);
   ept_1_stack_5->SetMinimum(-0);
   ept_1_stack_5->SetMaximum(nan);
   ept_1_stack_5->SetEntries(86);
   ...
   ept_1->SetBinContent(0,10.86905);
   ept_1->SetBinError(0,3.719117);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,78.92046);
   ept_1->SetBinError(0,6.289136);
   ept_1->SetEntries(242);
   ept_1->SetStats(0);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,350.4835);
   ept_1->SetBinError(0,15.10316);
   ept_1->SetEntries(1034);
   ept_1->SetStats(0);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,93.13949);
   ept_1->SetBinError(0,1.238639);
   ept_1->SetEntries(7302);
   ept_1->SetStats(0);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,18.26875);
   ept_1->SetBinError(0,2.265807);
   ept_1->SetEntries(142);
   ept_1->SetStats(0);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,25.08348);
   ept_1->SetBinError(0,1.850195);
   ept_1->SetEntries(406);
   ept_1->SetStats(0);
   ept_1->SetFillColor(3);
   ept_1->SetLineColor(3);
   ept_1->SetLineWidth(2);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,5.566658);
   ept_1->SetBinError(0,0.1740935);
   ept_1->SetEntries(1384);
   ept_1->SetStats(0);
   ept_1->SetFillColor(3);
   ept_1->SetLineColor(3);
   ept_1->SetLineWidth(2);
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,3223);
   ept_1->SetBinError(0,56.77147);
   ept_1->SetEntries(3223);
   ept_1->SetStats(0);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *ept_1 = new TH1F("ept_1","ept_1",25,0,1000);
   ept_1->SetBinContent(0,5.639917);
   ept_1->SetBinError(0,0.1921609);
   ept_1->SetMinimum(0);
   ept_1->SetMaximum(2);
   ept_1->SetStats(0);
   ept_1->SetFillStyle(0);

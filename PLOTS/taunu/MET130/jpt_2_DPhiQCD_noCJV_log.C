...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-202.5316,-2.8454,1063.291,6.112156);
   ...
   stack->SetMaximum(188041.2);
   
   TH1F *jpt_2_stack_9 = new TH1F("jpt_2_stack_9","stack",25,0,1000);
   jpt_2_stack_9->SetMinimum(0.002156508);
   jpt_2_stack_9->SetMaximum(461613.1);
   ...
   TH1F *jpt_2 = new TH1F("jpt_2","jpt_2",25,0,1000);
   jpt_2->SetBinContent(2,7.847571);
   jpt_2->SetBinContent(3,5.91048);
   jpt_2->SetBinContent(4,3.074449);
   jpt_2->SetBinContent(8,0.4197137);
   jpt_2->SetBinError(2,2.215442);
   jpt_2->SetBinError(3,1.501359);
   jpt_2->SetBinError(4,1.327553);
   ...
   TH1F *jpt_2 = new TH1F("jpt_2","jpt_2",25,0,1000);
   jpt_2->SetBinContent(2,2.341962);
   jpt_2->SetBinContent(3,1.935314);
   jpt_2->SetBinContent(4,0.9568907);
   jpt_2->SetBinContent(5,0.5309805);
   jpt_2->SetBinContent(6,0.1321267);
   jpt_2->SetBinContent(7,0.1082644);
   jpt_2->SetBinContent(8,0.02239261);
   jpt_2->SetBinContent(9,0.01964042);
   jpt_2->SetBinError(2,0.2192774);
   jpt_2->SetBinError(3,0.1987198);
   jpt_2->SetBinError(4,0.1352954);
   jpt_2->SetBinError(5,0.1059687);
   jpt_2->SetBinError(6,0.05106838);
   jpt_2->SetBinError(7,0.04533742);
   jpt_2->SetBinError(8,0.02113697);
   jpt_2->SetBinError(9,0.01964042);
   jpt_2->SetEntries(353);
   jpt_2->SetStats(0);
   ...
   TH1F *jpt_2 = new TH1F("jpt_2","jpt_2",25,0,1000);
   jpt_2->SetBinContent(2,0.5468798);
   jpt_2->SetBinContent(3,0.4428219);
   jpt_2->SetBinContent(4,0.1718155);
   jpt_2->SetBinContent(6,0.09741174);
   jpt_2->SetBinError(2,0.2835112);
   jpt_2->SetBinError(3,0.2353545);
   ...
   TH1F *jpt_2 = new TH1F("jpt_2","jpt_2",25,0,1000);
   jpt_2->SetBinContent(2,0.04858435);
   jpt_2->SetBinContent(3,0.05687107);
   jpt_2->SetBinContent(4,0.0412967);
   ...
   jpt_2->SetBinError(2,0.01970457);
   jpt_2->SetBinError(3,0.01945158);
   jpt_2->SetBinError(4,0.01769593);
   ...
   TH1F *jpt_2 = new TH1F("jpt_2","jpt_2",25,0,1000);
   jpt_2->SetBinContent(2,29);
   jpt_2->SetBinContent(3,21);
   jpt_2->SetBinContent(4,11);
   jpt_2->SetBinContent(5,2);
   jpt_2->SetBinContent(7,1);
   jpt_2->SetBinError(2,5.385165);
   jpt_2->SetBinError(3,4.582576);
   jpt_2->SetBinError(4,3.316625);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *jpt_2 = new TH1F("jpt_2","jpt_2",25,0,1000);
   jpt_2->SetBinContent(2,2.313322);
   jpt_2->SetBinContent(3,2.220459);
   jpt_2->SetBinContent(4,2.446392);
   jpt_2->SetBinContent(5,1.392619);
   jpt_2->SetBinContent(7,5.125386);
   jpt_2->SetBinError(2,0.6303336);
   jpt_2->SetBinError(3,0.6272113);
   jpt_2->SetBinError(4,1.046976);
   jpt_2->SetBinError(5,1.24635);
   jpt_2->SetBinError(7,5.735198);
   jpt_2->SetMinimum(0);
   jpt_2->SetMaximum(2);
   jpt_2->SetEntries(5.01478);
   jpt_2->SetStats(0);
   jpt_2->SetFillStyle(0);
   jpt_2->SetMarkerStyle(20);
   jpt_2->SetMarkerSize(0.8);

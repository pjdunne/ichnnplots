...
// ------------>Primitives in pad: upper
   ...
   mt_munu_stack_8->SetBinContent(0,2.628311);
   mt_munu_stack_8->SetBinError(0,2.2551);
   mt_munu_stack_8->SetMinimum(0.003049592);
   mt_munu_stack_8->SetMaximum(691.2936);
   mt_munu_stack_8->SetEntries(6);

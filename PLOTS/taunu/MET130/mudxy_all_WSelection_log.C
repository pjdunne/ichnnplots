...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.405063,-2.767966,1.126582,4.951717);
   ...
   stack->SetMaximum(16402.39);
   
   TH1F *mudxy_all_stack_2 = new TH1F("mudxy_all_stack_2","stack",100,-1,1);
   mudxy_all_stack_2->SetMinimum(0.002434598);
   mudxy_all_stack_2->SetMaximum(36790.25);
   ...
   TH1F *mudxy_all = new TH1F("mudxy_all","mudxy_all",100,-1,1);
   mudxy_all->SetBinContent(50,0.8781627);
   mudxy_all->SetBinContent(51,1.093493);
   mudxy_all->SetBinError(50,0.09042547);
   mudxy_all->SetBinError(51,0.09720812);
   mudxy_all->SetEntries(367);
   mudxy_all->SetStats(0);
   mudxy_all->SetFillColor(3);
   mudxy_all->SetLineColor(3);
   mudxy_all->SetLineWidth(2);

...
//=========  (Mon Nov 18 17:57:40 2013) by ROOT version5.32/00
...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-2.810127,-2.711439,2.253165,4.164136);
   ...
   stack->SetMaximum(3149.285);
   
   TH1F *mudz_all_stack_13 = new TH1F("mudz_all_stack_13","stack",100,-2,2);
   mudz_all_stack_13->SetMinimum(0.002667303);
   mudz_all_stack_13->SetMaximum(6612.372);
   ...
   TH1F *mudz_all = new TH1F("mudz_all","mudz_all",100,-2,2);
   mudz_all->SetBinContent(50,0.1831331);
   mudz_all->SetBinContent(51,0.2099523);
   mudz_all->SetBinError(50,0.04797689);
   mudz_all->SetBinError(51,0.05063396);
   mudz_all->SetEntries(37);
   mudz_all->SetStats(0);
   mudz_all->SetFillColor(3);
   mudz_all->SetLineColor(3);
   mudz_all->SetLineWidth(2);

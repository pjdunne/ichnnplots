...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-2.810127,-2.635072,2.253165,3.17853);
   ...
   stack->SetMaximum(402.1161);
   
   TH1F *mudz_all_stack_9 = new TH1F("mudz_all_stack_9","stack",100,-2,2);
   mudz_all_stack_9->SetMinimum(0.003028306);
   mudz_all_stack_9->SetMaximum(772.4129);
   mudz_all_stack_9->SetStats(0);
   mudz_all_stack_9->SetFillColor(4);
   mudz_all_stack_9->SetLineColor(4);
   mudz_all_stack_9->SetLineWidth(2);
   mudz_all_stack_9->SetMarkerColor(4);
   mudz_all_stack_9->SetMarkerStyle(21);
   mudz_all_stack_9->SetMarkerSize(0.8);
   mudz_all_stack_9->GetXaxis()->SetTitle("Muon d_{z}");
   mudz_all_stack_9->GetXaxis()->SetLabelFont(42);
   mudz_all_stack_9->GetXaxis()->SetLabelOffset(0.007);
   mudz_all_stack_9->GetXaxis()->SetLabelSize(0);
   mudz_all_stack_9->GetXaxis()->SetTitleSize(0);
   mudz_all_stack_9->GetXaxis()->SetTickLength(0.02);
   mudz_all_stack_9->GetXaxis()->SetTitleOffset(0.9);
   mudz_all_stack_9->GetXaxis()->SetTitleFont(42);
   mudz_all_stack_9->GetYaxis()->SetTitle("Events");
   mudz_all_stack_9->GetYaxis()->SetLabelFont(42);
   mudz_all_stack_9->GetYaxis()->SetLabelOffset(0.007);
   mudz_all_stack_9->GetYaxis()->SetLabelSize(0.035);
   mudz_all_stack_9->GetYaxis()->SetTitleSize(0.045);
   mudz_all_stack_9->GetYaxis()->SetTickLength(0.02);
   mudz_all_stack_9->GetYaxis()->SetTitleOffset(1.55);
   mudz_all_stack_9->GetYaxis()->SetTitleFont(42);
   mudz_all_stack_9->GetZaxis()->SetLabelFont(42);
   mudz_all_stack_9->GetZaxis()->SetLabelOffset(0.007);
   mudz_all_stack_9->GetZaxis()->SetLabelSize(0.035);
   mudz_all_stack_9->GetZaxis()->SetTitleSize(0.045);
   mudz_all_stack_9->GetZaxis()->SetTickLength(0.02);
   mudz_all_stack_9->GetZaxis()->SetTitleFont(42);
   stack->SetHistogram(mudz_all_stack_9);
   
   
   TH1F *mudz_all = new TH1F("mudz_all","mudz_all",100,-2,2);
   mudz_all->SetMinimum(0.01);
   mudz_all->SetMaximum(402.1161);
   mudz_all->SetStats(0);
   ...
   TH1F *mudz_all = new TH1F("mudz_all","mudz_all",100,-2,2);
   mudz_all->SetBinContent(50,0.02680774);
   mudz_all->SetBinContent(51,0.01937894);
   mudz_all->SetBinError(50,0.01844558);
   mudz_all->SetBinError(51,0.01422421);
   mudz_all->SetEntries(6);
   mudz_all->SetStats(0);
   mudz_all->SetFillColor(3);
   mudz_all->SetLineColor(3);
   mudz_all->SetLineWidth(2);

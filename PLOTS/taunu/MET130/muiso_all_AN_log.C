...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-0.4050633,-2.740927,2.126582,4.568757);
   ...
   stack->SetMaximum(7347.955);
   
   TH1F *muiso_all_stack_4 = new TH1F("muiso_all_stack_4","stack",100,0,2);
   muiso_all_stack_4->SetMinimum(0.002542535);
   muiso_all_stack_4->SetMaximum(15968.82);
   ...
   TH1F *muiso_all = new TH1F("muiso_all","muiso_all",100,0,2);
   muiso_all->SetBinContent(1,0.4898636);
   muiso_all->SetBinContent(2,0.07412516);
   muiso_all->SetBinContent(3,0.01387375);
   muiso_all->SetBinContent(4,0.02808208);
   muiso_all->SetBinError(1,0.07757639);
   muiso_all->SetBinError(2,0.02909657);
   muiso_all->SetBinError(3,0.01302131);
   muiso_all->SetBinError(4,0.01988589);
   muiso_all->SetEntries(62);
   muiso_all->SetStats(0);
   muiso_all->SetFillColor(3);
   muiso_all->SetLineColor(3);
   muiso_all->SetLineWidth(2);

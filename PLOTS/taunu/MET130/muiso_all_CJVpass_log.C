...
//=========  (Mon Nov 18 17:57:44 2013) by ROOT version5.32/00
...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-0.4050633,-2.727223,2.126582,4.379032);
   ...
   stack->SetMaximum(4938.173);
   
   TH1F *muiso_all_stack_13 = new TH1F("muiso_all_stack_13","stack",100,0,2);
   muiso_all_stack_13->SetMinimum(0.002599575);
   muiso_all_stack_13->SetMaximum(10561.34);
   ...
   TH1F *muiso_all = new TH1F("muiso_all","muiso_all",100,0,2);
   muiso_all->SetBinContent(1,0.3292115);
   muiso_all->SetBinContent(2,0.05059006);
   muiso_all->SetBinContent(4,0.01328382);
   muiso_all->SetBinError(1,0.0641902);
   muiso_all->SetBinError(2,0.02384824);
   muiso_all->SetBinError(4,0.01328382);
   muiso_all->SetEntries(37);
   muiso_all->SetStats(0);
   muiso_all->SetFillColor(3);
   muiso_all->SetLineColor(3);
   muiso_all->SetLineWidth(2);

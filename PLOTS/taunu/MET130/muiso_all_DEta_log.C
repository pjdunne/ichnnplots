...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-0.4050633,-2.755097,2.126582,4.768024);
   ...
   stack->SetMaximum(11157.61);
   
   TH1F *muiso_all_stack_5 = new TH1F("muiso_all_stack_5","stack",100,0,2);
   muiso_all_stack_5->SetMinimum(0.002485222);
   muiso_all_stack_5->SetMaximum(24652.9);
   ...
   TH1F *muiso_all = new TH1F("muiso_all","muiso_all",100,0,2);
   muiso_all->SetBinContent(1,0.7438408);
   muiso_all->SetBinContent(2,0.1770558);
   muiso_all->SetBinContent(3,0.03577012);
   muiso_all->SetBinContent(4,0.02902726);
   muiso_all->SetBinContent(5,0.01557326);
   muiso_all->SetBinError(1,0.08700702);
   muiso_all->SetBinError(2,0.04174366);
   muiso_all->SetBinError(3,0.02033378);
   muiso_all->SetBinError(4,0.01659544);
   muiso_all->SetBinError(5,0.01277338);
   muiso_all->SetEntries(128);
   muiso_all->SetStats(0);
   muiso_all->SetFillColor(3);
   muiso_all->SetLineColor(3);
   muiso_all->SetLineWidth(2);

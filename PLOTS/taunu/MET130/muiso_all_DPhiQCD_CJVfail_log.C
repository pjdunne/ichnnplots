...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-0.4050633,-2.608283,2.126582,2.853736);
   ...
   muiso_all_stack_12->SetMinimum(0.003169258);
   muiso_all_stack_12->SetMaximum(380.7454);
   ...
   TH1F *muiso_all = new TH1F("muiso_all","muiso_all",100,0,2);
   muiso_all->SetBinContent(1,0.01363121);
   muiso_all->SetBinContent(2,0.01363121);
   muiso_all->SetBinError(1,0.01363121);
   muiso_all->SetBinError(2,0.01363121);
   muiso_all->SetEntries(2);
   muiso_all->SetStats(0);
   muiso_all->SetFillColor(3);
   muiso_all->SetLineColor(3);
   muiso_all->SetLineWidth(2);

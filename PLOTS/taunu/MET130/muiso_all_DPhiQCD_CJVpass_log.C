...
//=========  (Mon Nov 18 17:57:45 2013) by ROOT version5.32/00
...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-0.4050633,-2.642599,2.126582,3.271728);
   ...
   stack->SetMaximum(488.332);
   
   TH1F *muiso_all_stack_15 = new TH1F("muiso_all_stack_15","stack",100,0,2);
   muiso_all_stack_15->SetMinimum(0.002990111);
   muiso_all_stack_15->SetMaximum(946.262);
   ...
   TH1F *muiso_all = new TH1F("muiso_all","muiso_all",100,0,2);
   muiso_all->SetBinContent(1,0.03255547);
   muiso_all->SetBinContent(2,0.01363121);
   muiso_all->SetBinError(1,0.01888803);
   muiso_all->SetBinError(2,0.01363121);
   muiso_all->SetEntries(6);
   muiso_all->SetStats(0);
   muiso_all->SetFillColor(3);
   muiso_all->SetLineColor(3);
   muiso_all->SetLineWidth(2);

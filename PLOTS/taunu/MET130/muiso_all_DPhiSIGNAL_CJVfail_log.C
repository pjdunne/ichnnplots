...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-0.4050633,-2.627529,2.126582,3.085993);
   ...
   stack->SetMaximum(331.6051);
   
   TH1F *muiso_all_stack_11 = new TH1F("muiso_all_stack_11","stack",100,0,2);
   muiso_all_stack_11->SetMinimum(0.003067192);
   muiso_all_stack_11->SetMaximum(631.4173);
   ...
   TH1F *muiso_all = new TH1F("muiso_all","muiso_all",100,0,2);
   muiso_all->SetBinContent(1,0.02210701);
   muiso_all->SetBinContent(2,0.008904863);
   muiso_all->SetBinError(1,0.01563201);
   muiso_all->SetBinError(2,0.006296689);
   muiso_all->SetEntries(4);
   muiso_all->SetStats(0);
   muiso_all->SetFillColor(3);
   muiso_all->SetLineColor(3);
   muiso_all->SetLineWidth(2);

...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-0.4050633,-2.665001,2.126582,3.554178);
   ...
   stack->SetMaximum(880.242);
   
   TH1F *muiso_all_stack_8 = new TH1F("muiso_all_stack_8","stack",100,0,2);
   muiso_all_stack_8->SetMinimum(0.002879935);
   muiso_all_stack_8->SetMaximum(1750.731);
   ...
   TH1F *muiso_all = new TH1F("muiso_all","muiso_all",100,0,2);
   muiso_all->SetBinContent(1,0.0586828);
   muiso_all->SetBinContent(2,0.008904863);
   muiso_all->SetBinError(1,0.02628204);
   muiso_all->SetBinError(2,0.006296689);
   muiso_all->SetEntries(7);
   muiso_all->SetStats(0);
   muiso_all->SetFillColor(3);
   muiso_all->SetLineColor(3);
   muiso_all->SetLineWidth(2);

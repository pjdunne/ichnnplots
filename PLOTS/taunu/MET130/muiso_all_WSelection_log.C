...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-0.4050633,-2.776695,2.126582,5.077794);
   ...
   stack->SetMaximum(21370.58);
   
   TH1F *muiso_all_stack_2 = new TH1F("muiso_all_stack_2","stack",100,0,2);
   muiso_all_stack_2->SetMinimum(0.002401013);
   muiso_all_stack_2->SetMaximum(48424.95);
   ...
   TH1F *muiso_all = new TH1F("muiso_all","muiso_all",100,0,2);
   muiso_all->SetBinContent(1,1.424705);
   muiso_all->SetBinContent(2,0.3275497);
   muiso_all->SetBinContent(3,0.08938437);
   muiso_all->SetBinContent(4,0.06217781);
   muiso_all->SetBinContent(5,0.03108706);
   muiso_all->SetBinContent(6,0.03675107);
   muiso_all->SetBinError(1,0.1132474);
   muiso_all->SetBinError(2,0.05408687);
   muiso_all->SetBinError(3,0.02862594);
   muiso_all->SetBinError(4,0.02441947);
   muiso_all->SetBinError(5,0.01493737);
   muiso_all->SetBinError(6,0.01539285);
   muiso_all->SetEntries(367);
   muiso_all->SetStats(0);
   muiso_all->SetFillColor(3);
   muiso_all->SetLineColor(3);
   muiso_all->SetLineWidth(2);

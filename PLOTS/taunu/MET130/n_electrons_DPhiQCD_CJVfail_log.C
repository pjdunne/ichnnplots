...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.865647,6.379747,6.431262);
   ...
   stack->SetMaximum(368284.2);
   
   TH1F *n_electrons_stack_12 = new TH1F("n_electrons_stack_12","stack",10,0,10);
   n_electrons_stack_12->SetMinimum(0.002090698);
   n_electrons_stack_12->SetMaximum(925585.3);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(1,14.86245);
   n_electrons->SetBinError(1,2.765986);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(1,4.722701);
   n_electrons->SetBinError(1,0.3093116);
   n_electrons->SetEntries(280);
   n_electrons->SetStats(0);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(1,0.7332919);
   n_electrons->SetBinError(1,0.313866);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(1,0.1474053);
   n_electrons->SetBinError(1,0.03276624);
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(1,47);
   n_electrons->SetBinError(1,6.855655);
...
// ------------>Primitives in pad: lower
   ...
   TH1F *n_electrons = new TH1F("n_electrons","n_electrons",10,0,10);
   n_electrons->SetBinContent(1,1.914283);
   n_electrons->SetBinError(1,0.3745931);
   n_electrons->SetMinimum(0);
   n_electrons->SetMaximum(2);
   n_electrons->SetEntries(26.11515);
   n_electrons->SetStats(0);
   n_electrons->SetFillStyle(0);
   n_electrons->SetMarkerStyle(20);
   n_electrons->SetMarkerSize(0.8);

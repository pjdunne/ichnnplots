...
// ------------>Primitives in pad: upper
   ...
   TH1F *n_electrons_stack_7 = new TH1F("n_electrons_stack_7","stack",10,0,10);
   n_electrons_stack_7->SetBinContent(1,5.305786);
   n_electrons_stack_7->SetBinError(1,3.039894);
   n_electrons_stack_7->SetMinimum(0.001918146);
   n_electrons_stack_7->SetMaximum(7173586);
   n_electrons_stack_7->SetEntries(15);
   n_electrons_stack_7->SetStats(0);
   n_electrons_stack_7->SetFillColor(4);
   n_electrons_stack_7->SetLineColor(4);
   n_electrons_stack_7->SetLineWidth(2);
   n_electrons_stack_7->SetMarkerColor(4);
   n_electrons_stack_7->SetMarkerStyle(21);
   n_electrons_stack_7->SetMarkerSize(0.8);
   n_electrons_stack_7->GetXaxis()->SetTitle("Number of electrons");
   n_electrons_stack_7->GetXaxis()->SetRange(1,6);
   n_electrons_stack_7->GetXaxis()->SetLabelFont(42);
   n_electrons_stack_7->GetXaxis()->SetLabelOffset(0.007);
   n_electrons_stack_7->GetXaxis()->SetLabelSize(0);
   n_electrons_stack_7->GetXaxis()->SetTitleSize(0);
   n_electrons_stack_7->GetXaxis()->SetTickLength(0.02);
   n_electrons_stack_7->GetXaxis()->SetTitleOffset(0.9);
   n_electrons_stack_7->GetXaxis()->SetTitleFont(42);
   n_electrons_stack_7->GetYaxis()->SetTitle("Events");
   n_electrons_stack_7->GetYaxis()->SetLabelFont(42);
   n_electrons_stack_7->GetYaxis()->SetLabelOffset(0.007);
   n_electrons_stack_7->GetYaxis()->SetLabelSize(0.035);
   n_electrons_stack_7->GetYaxis()->SetTitleSize(0.045);
   n_electrons_stack_7->GetYaxis()->SetTickLength(0.02);
   n_electrons_stack_7->GetYaxis()->SetTitleOffset(1.55);
   n_electrons_stack_7->GetYaxis()->SetTitleFont(42);
   n_electrons_stack_7->GetZaxis()->SetLabelFont(42);
   n_electrons_stack_7->GetZaxis()->SetLabelOffset(0.007);
   n_electrons_stack_7->GetZaxis()->SetLabelSize(0.035);
   n_electrons_stack_7->GetZaxis()->SetTitleSize(0.045);
   n_electrons_stack_7->GetZaxis()->SetTickLength(0.02);
   n_electrons_stack_7->GetZaxis()->SetTitleFont(42);
   stack->SetHistogram(n_electrons_stack_7);

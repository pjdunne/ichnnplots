...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-4.253164,-2.812098,22.32911,5.601455);
   ...
   stack->SetMaximum(64207.52);
   
   TH1F *n_jetsingap_stack_15 = new TH1F("n_jetsingap_stack_15","stack",50,0,50);
   n_jetsingap_stack_15->SetMinimum(0.00227077);
   n_jetsingap_stack_15->SetMaximum(151627.2);
...
// ------------>Primitives in pad: lower
   ...
   n_jetsingap->SetEntries(6.962767);
   n_jetsingap->SetStats(0);
   n_jetsingap->SetFillStyle(0);
   n_jetsingap->SetMarkerStyle(20);
   n_jetsingap->SetMarkerSize(0.8);

...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.69008,6.379747,3.879474);
   ...
   stack->SetMaximum(1736.521);
   
   TH1F *n_taus_stack_5 = new TH1F("n_taus_stack_5","stack",10,0,10);
   n_taus_stack_5->SetBinContent(2,10.78324);
   n_taus_stack_5->SetBinContent(3,0.08581164);
   n_taus_stack_5->SetBinError(2,3.718504);
   n_taus_stack_5->SetBinError(3,0.06755113);
   n_taus_stack_5->SetMinimum(0.002762553);
   n_taus_stack_5->SetMaximum(3556.285);
   n_taus_stack_5->SetEntries(86);

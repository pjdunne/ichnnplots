...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.565939,6.379747,2.362093);
   ...
   stack->SetMaximum(73.60205);
   
   TH1F *n_taus_stack_12 = new TH1F("n_taus_stack_12","stack",10,0,10);
   n_taus_stack_12->SetMinimum(0.003408961);
   n_taus_stack_12->SetMaximum(130.5243);

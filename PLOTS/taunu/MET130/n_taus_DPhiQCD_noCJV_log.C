...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-1.21519,-2.572764,6.379747,2.439557);
   ...
   stack->SetMaximum(86.44355);
   
   TH1F *n_taus_stack_9 = new TH1F("n_taus_stack_9","stack",10,0,10);
   n_taus_stack_9->SetMinimum(0.003368856);
   n_taus_stack_9->SetMaximum(154.5046);

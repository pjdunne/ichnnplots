...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-85.06329,-2.807212,446.5823,5.528013);
   ...
   taupt_1_stack_5->SetMinimum(0.00228819);
   taupt_1_stack_5->SetMaximum(129196.7);

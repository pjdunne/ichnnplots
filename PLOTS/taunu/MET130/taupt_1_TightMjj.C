...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(-44.55696,-3.054936,233.9241,149.6919);
   ...
   stack->SetMaximum(135.29);
   
   TH1F *taupt_1_stack_7 = new TH1F("taupt_1_stack_7","stack",50,0,1000);
   taupt_1_stack_7->SetBinContent(2,2.930595);
   taupt_1_stack_7->SetBinContent(3,2.24644);
   taupt_1_stack_7->SetBinContent(4,0.1287503);
   taupt_1_stack_7->SetBinError(2,2.263126);
   taupt_1_stack_7->SetBinError(3,2.025498);
   taupt_1_stack_7->SetBinError(4,0.1287503);
   taupt_1_stack_7->SetMinimum(0);
   taupt_1_stack_7->SetMaximum(142.0545);
   taupt_1_stack_7->SetEntries(15);
